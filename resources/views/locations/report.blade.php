                            ...
                            <div class="col-xl-4 col-xxl-4 col-sm-6">
                                <div class="widget-stat card">
                                    <div class="card-body">
                                        ...
                                        <h3>MWK {{ number_format($location_report['target'],2) }}</h3>
                                        <div class="progress mb-2">
                                            <div class="progress-bar progress-animated bg-primary"
                                                style="width: {{ $location_report['target'] }}%"></div>
                                        </div>
                                        <small>MWK {{  number_format($location_report['target'],2) }} </small>
                                    </div>
                                </div>
                            </div>
                            @php
                            ...
                            <div class="col-xl-4 col-xxl-4 col-sm-6">
                                <div class="widget-stat card">
                                    <div class="card-body">
                                        ...
                                        <h3>MWK {{ number_format($location_report['total_collected'],2) }}</h3>
                                        <div class="progress mb-2">
                                        ...
                                        <small>MWK {{ number_format($location_report['total_collected'],2) }} </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-xxl-4 col-sm-6">
                                <div class="widget-stat card">
                                    <div class="card-body">
                                        ...
                                        <h3>MWK {{ number_format($location_report['total_remaining'],2) }}</h3>
                                        <div class="progress mb-2">
                                            <div class="progress-bar progress-animated"
                                                style="background-color:red;width: {{ $location_report['total_remaining'] }}% "></div>
                                        </div>
                                        <small>MWK {{ number_format($location_report['total_remaining'],2) }} </small>
                                    </div>
                                </div>
                            </div>
                        </div>
