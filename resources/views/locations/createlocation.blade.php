<x-app-layout>
    ...
    {{-- NEW ADMIN FORM --}}
        ...
        <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <form class="forms-sample" action="{{route('locations.submit')}}" method="post">
                        @csrf
                        <div class="row">
                          <div class="form-group col-md-6 col-lg-6">
                            <label for="exampleInputName1">Fullname</label>
                            <input type="text" class="form-control" id="exampleInputName1" placeholder="Fullname" name="location_name" style="@error('location_name')border:1px red solid;@enderror" value="{{ old('location_name') }}">
                             @error('location_name')
                                <div style="color: red;">
                                    {{ $message }}
                                </div>
