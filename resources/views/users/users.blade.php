                            ...
                            @foreach ($users as $user)
                                @if (auth()->user()->hasRole('manager'))
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-warning" href="{{ route('users.edit', $user->id) }}"><i
                                                    class="fa fa-edit"></i> Edit </a> </td>

                                        <td> <a class="btn btn-primary" href="{{ route('users.view', $user->id) }}">More <i
                                                    class="mdi mdi-arrow-right"></i> </a> </td>

                                        <td>
                                            @if ($user->status === 'Active')
                                                <a class="btn btn-danger" href="{{ route('users.block', $user->id) }}"> <i
                                                        class="mdi mdi-block-helper"></i> Block </a>
                                            @elseif($user->status === 'Blocked')
                                                <a class="btn btn-success" href="{{ route('users.activate', $user->id) }}">
